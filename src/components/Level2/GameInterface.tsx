          ...
          {isMobile ? (
            ...
            <div className="grid lg:grid-cols-4 gap-6">
              ...
              <div className="lg:col-span-1">
                <div className="pixel-border-thick bg-gray-800 p-6 sticky top-6 overflow-hidden">
                  {/* Background Pattern */}
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center space-x-2 mb-4">
                      <div className="w-8 h-8 bg-cyan-500 pixel-border flex items-center justify-center">
                        <Gamepad2 className="w-5 h-5 text-cyan-900" />
                      </div>
                      <div>
                        <h2 className="text-lg font-black text-cyan-300 pixel-text">COMMAND CENTER</h2>
                    ...
                    {/* Score Display */}
                    <div className="mb-4 pixel-border bg-gradient-to-r from-yellow-600 to-orange-600 p-3">
                      <div className="text-center">
                        <div className="text-yellow-100 text-xs font-bold mb-1">CURRENT SCORE</div>
                        <div className="text-white text-2xl font-black pixel-text">{currentScore.toString().padStart(2, '0')}/40</div>
                    ...
                    <div className="space-y-3 max-h-96 overflow-y-auto mb-6">
                      ...
                      {getUnassignedTerms().length === 0 && !hasExecuted && (
                        <div className="text-center py-8">
                          <div className="w-16 h-16 bg-green-500 pixel-border mx-auto mb-3 flex items-center justify-center animate-bounce">
                            <Crown className="w-8 h-8 text-green-900" />
                          </div>
                          <p className="text-green-300 font-black pixel-text text-sm">ALL DEPLOYED!</p>
                          <p className="text-xs text-gray-400">Auto-executing mission...</p>
                        </div>
                      )}
                      {getUnassignedTerms().length === 0 && hasExecuted && (
                        <div className="text-center py-8">
                          <div className="w-16 h-16 bg-blue-500 pixel-border mx-auto mb-3 flex items-center justify-center animate-pulse">
                            <CheckCircle className="w-8 h-8 text-blue-900" />
                          </div>
                          <p className="text-blue-300 font-black pixel-text text-sm">MISSION COMPLETE!</p>
                    ...
                    <div className="mb-6">
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-cyan-300 text-sm font-bold pixel-text">PROGRESS</span>
                        <span className="text-white text-sm font-black">{Math.round(progress)}%</span>
                      </div>
                      <div className="pixel-border bg-gray-900 h-4 overflow-hidden">
                        <div 
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-6">
                      <div className="pixel-border bg-blue-900 p-2 text-center">
                        <div className="text-blue-300 text-xs font-bold">TIME</div>
                        <div className="text-white text-sm font-black">{formatTime(timeElapsed)}</div>
                      </div>
                      <div className="pixel-border bg-purple-900 p-2 text-center">
                        <div className="text-purple-300 text-xs font-bold">MOVES</div>
                        <div className="text-white text-sm font-black">{moves}</div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <button
                        onClick={resetGame}
                        className="w-full pixel-border bg-gray-700 hover:bg-gray-600 text-gray-300 hover:text-white py-3 px-4 font-bold pixel-text transition-all duration-200 hover:scale-105"
                      >
                      ...
                      <button
                        onClick={onBack}
                        className="w-full pixel-border bg-red-700 hover:bg-red-600 text-red-300 hover:text-white py-3 px-4 font-bold pixel-text transition-all duration-200 hover:scale-105"
                      >
                        <div className="flex items-center justify-center space-x-2">
              ...
              <div className="lg:col-span-3">
                <div className="grid gap-6">
                  {gameMode.categories.map((category, index) => (
                    <div
                      key={category.id}
                      className="animate-slideIn category-box"
          ...
          {showResults && (
            <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center p-2 z-50">
              <div className={`pixel-border-thick bg-gray-800 relative overflow-hidden ${
                isMobile 
                  ? 'w-full h-full max-w-none max-h-none p-3' 
                  : 'p-8 max-w-lg w-full'
              }`}>
                {/* Background Pattern */}
                <div className="absolute inset-0 bg-pixel-pattern opacity-10"></div>
                ...
                <div className={`relative z-10 text-center h-full ${isMobile ? 'flex flex-col justify-between' : ''}`}>
                  ...
                  {isMobile ? (
                    <>
                      ...
                      <div className="flex-1 flex items-center justify-center">
                        <div className="w-full">
                          ...
                          {/* Mission Stats - Horizontal Grid */}
                          <div className="grid grid-cols-3 gap-2 mb-3">
                            <div className="pixel-border bg-blue-900 p-2">
                            ...
                            <div className="pixel-border bg-purple-900 p-2">
                            ...
                            <div className="pixel-border bg-green-900 p-2">
                              <div className="text-green-300 text-xs font-bold pixel-text">STREAK</div>
                              <div className="text-white text-sm font-black pixel-text">{streak}</div>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <>
                      {/* Mission Status */}
                      <div className="mb-6">
                        <div className="text-gray-400 text-sm font-bold mb-2 pixel-text">MISSION STATUS</div>
                        <div className={`text-3xl font-black mb-2 pixel-text ${getPerformanceMessage(score).color}`}>
                          {getPerformanceMessage(score).message}
                        </div>
                      </div>
                      ...
                      {/* Rank Badge */}
                      <div className="mb-6">
                        <div className={`inline-block w-20 h-20 ${getScoreRank(score).bg} pixel-border flex items-center justify-center animate-bounce`}>
                          <span className={`text-3xl font-black pixel-text ${getScoreRank(score).color}`}>
                            {getScoreRank(score).rank}
                          </span>
                        </div>
                      </div>
                      ...
                      {/* Score Display */}
                      <div className="mb-6">
                        <div className="text-6xl font-black text-yellow-400 mb-2 pixel-text">
                          {currentScore}/40
                        </div>
                        <div className="text-4xl font-black text-cyan-300 mb-2 pixel-text">
                          {score}%
                        </div>
                        <p className="text-gray-300 text-lg font-bold pixel-text">
                          {totalCorrect}/{terms.length} TARGETS HIT
                        </p>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-8">
                        <div className="pixel-border bg-blue-900 p-3">
                          <div className="text-blue-300 text-xs font-bold pixel-text">TIME</div>
                          <div className="text-white text-lg font-black pixel-text">{formatTime(timeElapsed)}</div>
                        </div>
                        <div className="pixel-border bg-purple-900 p-3">
                          <div className="text-purple-300 text-xs font-bold pixel-text">MOVES</div>
                          <div className="text-white text-lg font-black pixel-text">{moves}</div>
                        </div>
                        <div className="pixel-border bg-green-900 p-3">
                          <div className="text-green-300 text-xs font-bold pixel-text">STREAK</div>
                          <div className="text-white text-lg font-black pixel-text">{streak}</div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        <button
                          onClick={() => setShowResults(false)}
                          className="w-full pixel-border-thick bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-400 hover:to-cyan-500 text-white px-8 py-4 font-black text-lg pixel-text transition-all duration-300 hover:scale-105"
                        >
                          CONTINUE MISSION
                        </button>
                        ...
                        <button
                          onClick={handleNextLevel}
                          className="w-full pixel-border-thick bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 text-white px-8 py-4 font-black text-lg pixel-text transition-all duration-300 hover:scale-105"
                        >
                          <div className="flex items-center justify-center space-x-2">
                            <span>NEXT LEVEL</span>
                        ...
                        <button
                          onClick={resetGame}
                          className="w-full pixel-border bg-gray-700 hover:bg-gray-600 text-gray-300 hover:text-white px-8 py-3 font-bold pixel-text transition-all duration-200 hover:scale-105"
                        >
                          RETRY MISSION
                        </button>
                      </div>
